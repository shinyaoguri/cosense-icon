...
export const GOOGLE_FONTS: FontGroup[] = [
  ["日本語 Sans",    ["Noto Sans JP", "M PLUS 1", "M PLUS 1p", "M PLUS 2", "M PLUS Rounded 1c", "M PLUS U", "Kosugi", "Kosugi Maru", "Sawarabi Gothic", "Zen Kaku Gothic New", "Zen Kaku Gothic Antique", "Zen Maru Gothic", "BIZ UDPGothic", "BIZ UDGothic"]],
  ...
  ["Mono",          ["M PLUS 1 Code", "Roboto Mono", "JetBrains Mono", "Fira Code", "Source Code Pro", "IBM Plex Mono", "Space Mono", "Inconsolata", "Cousine", "Ubuntu Mono", "Noto Sans Mono", "PT Mono", "Anonymous Pro", "DM Mono"]],
